...
namespace HeuristicAlgoApp_Backend.Models
{
    public class DataCollection
    {
        ...
        public DataCollection() {
            ...
            fitnessFunctions.Add(new FitnessFunction() { Id = 1, Name = "Fitness Function", TypeName = "Fitness Function Type", FileName = "Fitness Function File", Dimension = -1, Domain = new List<double[]> { new double[] { -5.12, 5.12 } } });
            fitnessFunctions.Add(new FitnessFunction() { Id = 2, Name = "Fitness Function 2", TypeName = "Fitness Function 2 Type", FileName = "Fitness Function 2 File", Dimension = -1, Domain = new List<double[]>() });
            fitnessFunctions.Add(new FitnessFunction() { Id = 3, Name = "Fitness Function 2D", TypeName = "Fitness Function 2D Type", FileName = "Fitness Function 2D File", Dimension = 2, Domain = new List<double[]> { new double[] { -10, 10 }, new double[] { -5, 5 } } });
        }
