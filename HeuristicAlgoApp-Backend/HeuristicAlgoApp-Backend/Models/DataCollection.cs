...
namespace HeuristicAlgoApp_Backend.Models
{
    public class DataCollection
    {
        ...
        public DataCollection() {
            ...
            algorithms.Add(new Algorithm(){Id=1,Name="Sample Algo",TypeName="Sample Algo Type", FileName="Sample Algo File", Parameters=new List<Parameter>() });
            algorithms.Add(new Algorithm() { Id = 2, Name = "Sample Algo 2", TypeName = "Sample Algo 2 Type", FileName = "Sample Algo 2 File", Parameters = new List<Parameter>() });
            fitnessFunctions.Add(new FitnessFunction() { Id = 1, Name = "Fitness Function", TypeName = "Fitness Function Type", FileName = "Fitness Function File", Dimension = -1, Domain = new double[,] { { -5.12, 5.12 } } });
            fitnessFunctions.Add(new FitnessFunction() { Id = 2, Name = "Fitness Function 2", TypeName = "Fitness Function 2 Type", FileName = "Fitness Function 2 File", Dimension = -1, Domain = new double[0,0] });
            fitnessFunctions.Add(new FitnessFunction() { Id = 3, Name = "Fitness Function 2D", TypeName = "Fitness Function 2D Type", FileName = "Fitness Function 2D File", Dimension = 2, Domain = new double[,] { { -10, 10 },{ -5, 5 } } });
        }
